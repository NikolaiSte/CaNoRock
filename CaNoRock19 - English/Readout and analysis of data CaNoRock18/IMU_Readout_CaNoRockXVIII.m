...
clear all;
close all;
load('C:\Users\nikolst\Desktop\CaNoRock_18_data\MainTM\CaNoRock_XVIII_Launch.mat');

G = 9.807;
D2R = pi/180;

%From datasheet
%http://www.invensense.com/wp-content/uploads/2016/06/DS-000192-ICM-20649-v1.0.pdf
INV_a_val = 1/1024;
INV_g_val = 1/8.2;
...
INV_accel_conv = INV_a_val/LSM_a_val;
INV_gyro_conv = INV_g_val/LSM_g_val;

do_plot = 1;
D1 = Data1_D1_GPSIMU__Raw;

GPSIMU = uint16(D1); %dataset(:,11);
time_GPSIMU = Data1_time_D1_GPSIMU;
time_offset = 174.8-4.058-0.1796;
